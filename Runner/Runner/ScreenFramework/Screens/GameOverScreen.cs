...
namespace Runner.ScreenFramework.Screens
{
    class GameOverScreen : GameScreen
    {
        ...
        public override void Draw(GameTime gameTime)
        {
            ...
            spriteBatch.DrawString(font, "Mobs Killed: " + Score, new Vector2(graphics.Viewport.Width / 2, 200), Color.White, 0, font.MeasureString("Mobs Killed: " + Score) / 2, 4f, SpriteEffects.None, 0);
